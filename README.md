...
- `flow`: random cave gardens. The NCA grows a flower potential field and particles follow it through open space, leaving trails.
...
python3 -m nca_game.train_flow --config configs/flow.yaml --out runs/flow
```
